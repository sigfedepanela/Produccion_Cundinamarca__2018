...
var style_ProduccindePanelaTon_2 = function(feature, resolution){
    ...
    if (value >= 71.040000 && value <= 1023.060000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1023.060000 && value <= 3648.270000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3648.270000 && value <= 12682.070000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 12682.070000 && value <= 17644.870000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 17644.870000 && value <= 39602.040000) {
            style = [ new ol.style.Style({
